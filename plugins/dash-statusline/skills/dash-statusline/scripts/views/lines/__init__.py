...
from views.lines.lines import line1, line_turn, line2, line3, line4, line5


def assemble(context, turn, lang, model, effort, thinking, path, git, tools, report, telemetry='') -> str:
    lines = [
        line1.compose(context),
        line_turn.compose(turn),
